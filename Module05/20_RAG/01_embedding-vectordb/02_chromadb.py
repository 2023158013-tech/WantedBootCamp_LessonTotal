"""
[목표]
1. VectorDB가 왜 필요한지 이해한다.

[필요성]
-LMS 강좌 50개를 매번 요청할 때마다 Embedding을 하게 되면 임베딩 시에 딜레이가 발생한다.
-따라서 최초 요청 시 임베딩 후 VectorDB에 저장해두면 이미 있는 데이터의 경우 임베딩할 필요가 없다.
"""
...
# MySQL에서 DDL 구문(테이블을 생성하는 구문이라고 생각한다.)
...
# Step 3. 강좌가 기록된 CSV 파일을 읽어들이고 ChromaDB에 저장
