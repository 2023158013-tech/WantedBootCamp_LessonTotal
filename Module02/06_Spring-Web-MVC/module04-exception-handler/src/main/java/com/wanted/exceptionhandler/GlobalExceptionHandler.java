...
/*comment
*  Advice 어노테이션은 AOP 파트에서 Advice
*  즉, 반복적으로 동작해야 할 코드를 뭉쳐둔 메서드를 의미하는 단어였다.
*  @ControllerAdvice도 마찬가지로 공통으로 발생하는 예외처리를 담당할 수 있는 기능을 수행한다.
*  */
...
public class GlobalExceptionHandler {
    ...
    *  또한 우리가 개발 시 발생할 수 있는 모든 예외를 핸들링할 수 없기 때문에
    *  대표적인 예외처리들만 핸들링, 사용자 정의의 예외처리들만 핸들링해두고
    *  그 외 예외는 Exception으로 default 설정을 해둔다.
    *  */
