...
/*comment
*  WebMvcConfigurer 인터페이스는 Spring MVC 패턴의 기본 설정은 유지하며
*  추가적인 커스터마이징이 필요할 때 구현하는 인터페이스다.
...
public class WebConfiguration implements WebMvcConfigurer {
    ...
    *  excludePathPatterns(..)
    *  -addPathPatterns으로 지정한 범위 중 인터셉트 동작을 적용하지 않고자 하는
    *   url 패턴을 지정하는 메서드
    *  -정적 리소스(css, js, images) 등 불필요한 호출과 부하를 막기 위해
    *   '반드시' 제외해야 한다.
    *  */
