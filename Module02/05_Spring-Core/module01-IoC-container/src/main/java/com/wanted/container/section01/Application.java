...
public class Application {
    public static void main(String[] args) {
        ...
        /*comment
        *  결제 시스템이 있다고 가정을 해본다.
        *  KakaoPay와 NaverPay가 있으며 Application에서는 PaymentService를 호출 시 결제 플랫폼 객체를 생성해서
        *  결제가 되는 시나리오를 구성해본다.
        *  */
        ...
        /*comment
        *  결제 게이트웨이를 만약 Kakao -> Naver로 바꾸면 어떻게 될까?
        *  문제점
        *  1. 결제 게이트웨이 구현체를 직접 변경해야 한다.
        *  2. 메소드 일치를 맞춰줘야 한다.
        *  3. 만약 전달인자 개수, 위치가 달랐다면 이 부분도 수정해야 한다.
        *  "개방-폐쇄 원칙(OCP)를 위반하며, 1개의 수정 시 여러 코드 수정이 필요하므로 코드의 유연성이 떨어지게 된다.
        *  소프트웨어 요소는 확장에 열려있어야 하며, 변경에 닫혀있어야 한다.*/
