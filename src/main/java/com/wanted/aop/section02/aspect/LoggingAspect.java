...
public class LoggingAspect {
    ...
    *  -(String, ..): 첫 번째는 String이어야 하며 나머지는 상관 없음.
    *  */

    @Before("execution(* com.wanted.aop.section02.MemberService.*(..))")
    public void logBefore(JoinPoint joinPoint) {
        //‼️JoinPoint는 Advice 메서드가 적용되는 지점에 대한 정보를 제공하는 객체이다.
    ...
    *  */
     ...
     * @AfterReturning
       ...
       returning: 메서드의 반환값을 result라는 이름의 매개변수로 받겠다는 의미
     ...
     * 사용 예시: 예외 관련 로그, 예외 흐름 복구 로직 등에 사용된다.
       -예외 흐름 복구 로직 -> 할 수 있긴 하지만 더 좋은 예외 처리로 하는 것이 좋다.
     */
