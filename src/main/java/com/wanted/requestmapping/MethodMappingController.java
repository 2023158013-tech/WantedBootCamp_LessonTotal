...
/*comment
*  Spring Boot App은 Tomcat이 내장되어 있다.
*  지금까지는 요청을 처리할 Servlet을 만들었다면
*  이제 Servlet은 Http 요청을 받는 즉시 @Controller 어노테이션이 달린 클래스에 처리를 위임한다.
*  */
@Controller
public class MethodMappingController {
    ...
    *  */
    ...
    public String registMenu(Model model) {
        ...
        * key-value 형태로 값을 담게 되며 응답 시 view에서 Model에 담긴 값을 사용할 수 있게 된다.
        ...
        * */
        ...
        /*comment
        *  Controller 계층의 마지막 임무는 사용자에게 어떤 응답을 해줄 것인지 결정한다.
        *  메서드의 반환타입을 String으로 한 후 문자열을 return하면
