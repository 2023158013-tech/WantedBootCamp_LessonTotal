...
public class AsyncExceptionController {
    ...
    @GetMapping("/void-exception") //void의 비동기 메서드가 예외를 throw 했을 때.
    public String voidException() {

        /*comment
        *  메인 요청 스레드에서 비동기 요청 스레드에서 발생하는 예외 타입을 핸들링하려고 해도 동작하지 않는다.
        *  별도의 스레드에서 동작을 하고 있기 때문에 비동기 메서드 관련 예외처리는 별도의 비동기 전용 예외 처리를 해줘야 한다.
        *  */
