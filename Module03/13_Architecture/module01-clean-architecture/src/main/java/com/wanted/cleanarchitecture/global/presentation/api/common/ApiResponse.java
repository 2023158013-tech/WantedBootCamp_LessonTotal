...
/*comment
*  해당 클래스는 global 공통 응답 포맷이다.
*  해당 계층은 presentation(외부와의 소통) 계층에 속하며, 내부 계층이 Http 응답 구조에 대해 몰라도 되게 만드는 것이 목적이다.
*  Instant -> Java 시간 관련 클래스. 해당 클래스는 시간 뿐만 아니라 지역도 나오기 때문ㅇ에 글로벌 시비스에서 많이 쓰인다.
*  */
