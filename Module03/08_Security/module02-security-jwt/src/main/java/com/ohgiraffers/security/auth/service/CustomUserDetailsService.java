...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    *  존재하는 유저이면 return 구문에서 SecurityContext에 들어갈 사용자 객체를 만들어준다.*/
    @Override
    @Transactional //기본적으로 제공되는 spring security 메서드(이때 username은 우리가 생각하는 userId)
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //리턴 구문이 중요(security context에 이 구문이 들어가게 됨.)
