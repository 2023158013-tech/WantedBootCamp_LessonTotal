...
public class Application02 {
    public static void main(String[] args) {
        ...
        *  ArrayList 활용하기!*/
        ...
        List<BookDTO> bookList = new ArrayList(); //책밖에 못 들어감
        ...
        //for-each 반복문(콜론 오른쪽에 있는 걸 하나씩 콜론 왼쪽에 담기를 반복)
        ...
        //가격 오름차순 정렬은 같이 해보았다.
        //그러면 이제 어떤 식으로 코드들이 상호작용하는지 확인을 했으니, 가격 내림차순, 제목 정렬 등을 시도해보자.
        //힌트: String 클래스에 compareTo() 메소드 활용
