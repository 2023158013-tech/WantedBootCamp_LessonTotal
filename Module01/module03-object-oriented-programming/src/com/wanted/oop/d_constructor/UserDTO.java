...
public class UserDTO {
    ...
    private String pwd;
    private String name;
    private LocalDateTime enrollData; //등록일

    /*comment
    *  생성자의 사용 목적
    *  1. 객체 생성 시점에 수행할 명령이 있는 겨웅에 사용한다.
    *  2. 매개변수가 있는 생성자의 경우 매개변수로 전달 받은 값으로 기본값이 아닌 필드를 초기화하면서 객체를 생성할 목적으로 사용한다.
    ...
    *  따라서 이 점을 주의하자.*/
    ...
    //메소드명이 똑같은데 에러가 나지 않음(매개변수에 따라 같을 수 있음)
    //매개변수가 있는 생성자
