...
public class Application {
    public static void main(String[] args) {
        ...
        *  객체를 설계하기 위해서는 복잡한 현실 세계를 그대로 반영하기에는 너무 방대하고 복잡하다.
        *  따라서, 현실 세계를 프로그램의 목적에 맞게 단순화하는 것을 추상화라고 한다.*/
        ...
        while (true) {
            ...
            switch (no) {
                case 1:
                    racer.startUp(); break;
                case 2:
                    racer.stepAccel(); break;
                case 3:
                    racer.stepBreak(); break;
                case 4:
                    racer.turnOff(); break;
                case 9:
