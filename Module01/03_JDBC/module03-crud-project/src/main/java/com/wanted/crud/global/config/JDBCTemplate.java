...
public class JDBCTemplate {
    ...
    * */
    ...
    //static 블록은 정적 코드 블록으로서 클래스가 로드될 때 한번만 실행된다.
    static {
        ...
        try {
            ...
            //HikariDataSource를 구성 시 필요한 환경세팅 객체
            ...
            config.setMaxLifetime(180000); //커넥션을 사용할 수 있는 최대 시간(밀리세컨드 단위 1000 = 1초)
            //30분 후 새롭게 생성한다.
